...
/* Header file for hardware control keys */
...
static const char *brupcmd[] = {"brightnessctl", "set", "2.5%+", NULL};
static const char *brdowncmd[] = {"brightnessctl", "set", "2.5%-", NULL};

//rofi special menus
static const char *appsmenu[] = {"appsmenu", NULL};
static const char *networkmenu[] = {"networkmenu.py", NULL};

static Key keys[] = {
	/* modifier                     key             					function        				argument */
	{MODKEY, 						XK_d, 								spawn, 							{.v = dmenucmd}},
	{MODKEY, 						XK_a, 								spawn, 							{.v = appsmenu}},
	{MODKEY, 						XK_n, 								spawn, 							{.v = networkmenu}},
	{MODKEY, 						XK_Return, 							spawn, 							{.v = termcmd}},
	{MODKEY, 						XK_w, 								spawn, 							{.v = web}},
	{MODKEY | ShiftMask,			XK_b, 								spawn, 							{.v = wall_changer}},
	...
	{MODKEY, 						XK_o, 								setlayout, 						{.v = &layouts[7]}},	// grid
